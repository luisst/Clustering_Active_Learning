...
speakers_info_json_ex = None  # Optional: Path to speakers_info.json
...
parser.add_argument('--speakers_info_json', default=speakers_info_json_ex, help='Optional: Path to speakers_info.json for speaker number mapping')
...
speakers_info_json = args.speakers_info_json
...
if speakers_info_json is not None:
    print(f'Using speakers info JSON: {speakers_info_json}')
else:
    print(f'No speakers info JSON provided - will use auto-enumeration')
...
dataset_dvectors = d_vectors_pretrained_model(mfcc_folder_path, percentage_test,
                                            ...
                                            speakers_info_json_path=speakers_info_json)
