...
parser.add_argument('--stg3_final_csv', type=valid_path, default=csv_folder_ex, help='Stg3 final csv from merged wavs folder path')
parser.add_argument('--stg3_separated_merged_wavs', type=valid_path, default=separated_folder_ex, help='Stg3 merged wavs separated in labels folder path')
...
csv_folder= args.stg3_final_csv
separated_wav_folder = args.stg3_separated_merged_wavs
...
if tda_flag:
    counts_pickle_path = Path.joinpath(merged_wav_folder.parent, 'counts_segments.pickle')
